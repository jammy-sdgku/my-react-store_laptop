...
import "./QuantityPicker.css"; // Assuming you have a CSS file for styles
  ...
  return (
    <div
      className={`quantity-picker ${
        disabled ? "quantity-picker--disabled" : ""
      }`}
    >
      <button
        type="button"
      ...
      {maxQuantity < 99 && (
        <span className="quantity-picker__max-notice">Max: {maxQuantity}</span>
      )}
    </div>
  );
}
